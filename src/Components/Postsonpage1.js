...
import vw from './Images/vw1.jpg'
import benz from './Images/mb1.jpg'
import bmw from './Images/bmw1.jpg'
import benzo from './Images/mb3.jpg'

function Postsonpage1() {
    return (
        <>
                    ...
                    <div className="row" >
                        <div className="col-md-4">
                            <div>
                                <article className="article">
                                    ...
                                    <img src={vw} className="img-fluid" alt="Responsive image"></img>
                                ...
                                <article className="article">
                                    <h1 className="article-title">Robots Have Feelings, Too</h1>
                                    <img src={benz} className="img-fluid" alt="Responsive image"></img>
                                    <div className="article-body">
                                        <p>
                                            The term “artificial intelligence” has been floating around since the
                                            mid-20th century &mdash; a phrase encompassing “the science and engineering
                        ...
                        <div className="col-md-4">
                            <div>
                                <article className="article">
                                    <h1 className="article-title">Robots Have Feelings, Too</h1>
                                    <img src={bmw} className="img-fluid" alt="Responsive image"></img>
                                    <div className="article-body">
                                        <p>
                                            The term “artificial intelligence” has been floating around since the
                                            mid-20th century &mdash; a phrase encompassing “the science and engineering
